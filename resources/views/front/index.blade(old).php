    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-4" href="https://mobirise.com"><span class="mbri-right mbr-iconfont mbr-iconfont-btn" style="color: rgb(255, 255, 255);"></span>
                        MOBIRISE
                    </a></span>
            </div>
        </div>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-white-outline display-4" href="https://mobirise.com"><span class="mbri-globe mbr-iconfont mbr-iconfont-btn"></span>
...
<section class="engine"><a href="https://mobirise.info/h">how to create your own web page for free</a></section><section class="header1 cid-rRugRhTU54 mbr-fullscreen mbr-parallax-background" id="header1-b">
...
<section class="features8 cid-rRug4geJhf mbr-parallax-background" id="features8-4">
...
<section class="header9 cid-rRufT8rexy mbr-fullscreen mbr-parallax-background" id="header9-3">
...
<section class="features11 cid-rRug6OcQfX" id="features11-5">
...
<section class="map1 cid-rRugI5R6Gz" id="map1-a">
...
<section class="mbr-section form1 cid-rRuggXR2TV" id="form1-6">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                <!---Formbuilder Form--->
                <form action="https://mobirise.com/" method="POST" class="mbr-form form-with-styler" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="tzVQXMhd4NXDyWGk/I9BzSKFkQAQXKS7+CTea10eJx2nkSxTjAiFmXJpGCG66ukXBWA4xOyC5fAF6JtLiKL2pzPywtw910isw4gASpDtF2DcxaiadFePgWI/cxHnlVCa">
                    <div class="row">
...
<section class="cid-rRugovL6DW" id="social-buttons2-8">
...
<section class="cid-rRugv9EEOF" id="footer2-9">
